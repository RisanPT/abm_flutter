...
@JsonKey(name: '_id') String get id; String get fullName;@JsonKey(name: 'studentId') String get admissionNumber;@JsonKey(name: 'grade') String get classroom; DateTime get dateOfBirth; Gender get gender; String? get bloodGroup; String get guardianName;@JsonKey(name: 'parentContact') String get guardianContact; String get address;@JsonKey(name: 'enrollmentDate') DateTime get admissionDate; double? get attendancePercentage; bool get isActive; String? get photoUrl; String? get parentIqamaId; String? get parentPassportId; String? get fatherWhatsapp; String? get motherWhatsapp; String get country; String? get state; String? get studentIqamaNumber; String? get studentIqamaUrl; String? get fatherOccupation; String? get motherOccupation; int get numberOfChildren; List<String> get childrenAges; String? get shift; bool get needsTransportation; double get transportationFee; bool get hasConcession; String get instituteId; double? get scholarshipAmount; double get feeDiscount;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is StudentModel&&(identical(other.id, id) || other.id == id)&&(identical(other.fullName, fullName) || other.fullName == fullName)&&(identical(other.admissionNumber, admissionNumber) || other.admissionNumber == admissionNumber)&&(identical(other.classroom, classroom) || other.classroom == classroom)&&(identical(other.dateOfBirth, dateOfBirth) || other.dateOfBirth == dateOfBirth)&&(identical(other.gender, gender) || other.gender == gender)&&(identical(other.bloodGroup, bloodGroup) || other.bloodGroup == bloodGroup)&&(identical(other.guardianName, guardianName) || other.guardianName == guardianName)&&(identical(other.guardianContact, guardianContact) || other.guardianContact == guardianContact)&&(identical(other.address, address) || other.address == address)&&(identical(other.admissionDate, admissionDate) || other.admissionDate == admissionDate)&&(identical(other.attendancePercentage, attendancePercentage) || other.attendancePercentage == attendancePercentage)&&(identical(other.isActive, isActive) || other.isActive == isActive)&&(identical(other.photoUrl, photoUrl) || other.photoUrl == photoUrl)&&(identical(other.parentIqamaId, parentIqamaId) || other.parentIqamaId == parentIqamaId)&&(identical(other.parentPassportId, parentPassportId) || other.parentPassportId == parentPassportId)&&(identical(other.fatherWhatsapp, fatherWhatsapp) || other.fatherWhatsapp == fatherWhatsapp)&&(identical(other.motherWhatsapp, motherWhatsapp) || other.motherWhatsapp == motherWhatsapp)&&(identical(other.country, country) || other.country == country)&&(identical(other.state, state) || other.state == state)&&(identical(other.studentIqamaNumber, studentIqamaNumber) || other.studentIqamaNumber == studentIqamaNumber)&&(identical(other.studentIqamaUrl, studentIqamaUrl) || other.studentIqamaUrl == studentIqamaUrl)&&(identical(other.fatherOccupation, fatherOccupation) || other.fatherOccupation == fatherOccupation)&&(identical(other.motherOccupation, motherOccupation) || other.motherOccupation == motherOccupation)&&(identical(other.numberOfChildren, numberOfChildren) || other.numberOfChildren == numberOfChildren)&&const DeepCollectionEquality().equals(other.childrenAges, childrenAges)&&(identical(other.shift, shift) || other.shift == shift)&&(identical(other.needsTransportation, needsTransportation) || other.needsTransportation == needsTransportation)&&(identical(other.transportationFee, transportationFee) || other.transportationFee == transportationFee)&&(identical(other.hasConcession, hasConcession) || other.hasConcession == hasConcession)&&(identical(other.instituteId, instituteId) || other.instituteId == instituteId)&&(identical(other.scholarshipAmount, scholarshipAmount) || other.scholarshipAmount == scholarshipAmount)&&(identical(other.feeDiscount, feeDiscount) || other.feeDiscount == feeDiscount));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,fullName,admissionNumber,classroom,dateOfBirth,gender,bloodGroup,guardianName,guardianContact,address,admissionDate,attendancePercentage,isActive,photoUrl,parentIqamaId,parentPassportId,fatherWhatsapp,motherWhatsapp,country,state,studentIqamaNumber,studentIqamaUrl,fatherOccupation,motherOccupation,numberOfChildren,const DeepCollectionEquality().hash(childrenAges),shift,needsTransportation,transportationFee,hasConcession,instituteId,scholarshipAmount,feeDiscount]);

@override
String toString() {
  return 'StudentModel(id: $id, fullName: $fullName, admissionNumber: $admissionNumber, classroom: $classroom, dateOfBirth: $dateOfBirth, gender: $gender, bloodGroup: $bloodGroup, guardianName: $guardianName, guardianContact: $guardianContact, address: $address, admissionDate: $admissionDate, attendancePercentage: $attendancePercentage, isActive: $isActive, photoUrl: $photoUrl, parentIqamaId: $parentIqamaId, parentPassportId: $parentPassportId, fatherWhatsapp: $fatherWhatsapp, motherWhatsapp: $motherWhatsapp, country: $country, state: $state, studentIqamaNumber: $studentIqamaNumber, studentIqamaUrl: $studentIqamaUrl, fatherOccupation: $fatherOccupation, motherOccupation: $motherOccupation, numberOfChildren: $numberOfChildren, childrenAges: $childrenAges, shift: $shift, needsTransportation: $needsTransportation, transportationFee: $transportationFee, hasConcession: $hasConcession, instituteId: $instituteId, scholarshipAmount: $scholarshipAmount, feeDiscount: $feeDiscount)';
}
...
@useResult
$Res call({
@JsonKey(name: '_id') String id, String fullName,@JsonKey(name: 'studentId') String admissionNumber,@JsonKey(name: 'grade') String classroom, DateTime dateOfBirth, Gender gender, String? bloodGroup, String guardianName,@JsonKey(name: 'parentContact') String guardianContact, String address,@JsonKey(name: 'enrollmentDate') DateTime admissionDate, double? attendancePercentage, bool isActive, String? photoUrl, String? parentIqamaId, String? parentPassportId, String? fatherWhatsapp, String? motherWhatsapp, String country, String? state, String? studentIqamaNumber, String? studentIqamaUrl, String? fatherOccupation, String? motherOccupation, int numberOfChildren, List<String> childrenAges, String? shift, bool needsTransportation, double transportationFee, bool hasConcession, String instituteId, double? scholarshipAmount, double feeDiscount
});
...
/// Create a copy of StudentModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? fullName = null,Object? admissionNumber = null,Object? classroom = null,Object? dateOfBirth = null,Object? gender = null,Object? bloodGroup = freezed,Object? guardianName = null,Object? guardianContact = null,Object? address = null,Object? admissionDate = null,Object? attendancePercentage = freezed,Object? isActive = null,Object? photoUrl = freezed,Object? parentIqamaId = freezed,Object? parentPassportId = freezed,Object? fatherWhatsapp = freezed,Object? motherWhatsapp = freezed,Object? country = null,Object? state = freezed,Object? studentIqamaNumber = freezed,Object? studentIqamaUrl = freezed,Object? fatherOccupation = freezed,Object? motherOccupation = freezed,Object? numberOfChildren = null,Object? childrenAges = null,Object? shift = freezed,Object? needsTransportation = null,Object? transportationFee = null,Object? hasConcession = null,Object? instituteId = null,Object? scholarshipAmount = freezed,Object? feeDiscount = null,}) {
...
as String?,fatherWhatsapp: freezed == fatherWhatsapp ? _self.fatherWhatsapp : fatherWhatsapp // ignore: cast_nullable_to_non_nullable
as String?,motherWhatsapp: freezed == motherWhatsapp ? _self.motherWhatsapp : motherWhatsapp // ignore: cast_nullable_to_non_nullable
as String?,country: null == country ? _self.country : country // ignore: cast_nullable_to_non_nullable
as String,state: freezed == state ? _self.state : state // ignore: cast_nullable_to_non_nullable
as String?,studentIqamaNumber: freezed == studentIqamaNumber ? _self.studentIqamaNumber : studentIqamaNumber // ignore: cast_nullable_to_non_nullable
as String?,studentIqamaUrl: freezed == studentIqamaUrl ? _self.studentIqamaUrl : studentIqamaUrl // ignore: cast_nullable_to_non_nullable
as String?,fatherOccupation: freezed == fatherOccupation ? _self.fatherOccupation : fatherOccupation // ignore: cast_nullable_to_non_nullable
as String?,motherOccupation: freezed == motherOccupation ? _self.motherOccupation : motherOccupation // ignore: cast_nullable_to_non_nullable
as String?,numberOfChildren: null == numberOfChildren ? _self.numberOfChildren : numberOfChildren // ignore: cast_nullable_to_non_nullable
as int,childrenAges: null == childrenAges ? _self.childrenAges : childrenAges // ignore: cast_nullable_to_non_nullable
as List<String>,shift: freezed == shift ? _self.shift : shift // ignore: cast_nullable_to_non_nullable
...
as double?,feeDiscount: null == feeDiscount ? _self.feeDiscount : feeDiscount // ignore: cast_nullable_to_non_nullable
as double,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: '_id')  String id,  String fullName, @JsonKey(name: 'studentId')  String admissionNumber, @JsonKey(name: 'grade')  String classroom,  DateTime dateOfBirth,  Gender gender,  String? bloodGroup,  String guardianName, @JsonKey(name: 'parentContact')  String guardianContact,  String address, @JsonKey(name: 'enrollmentDate')  DateTime admissionDate,  double? attendancePercentage,  bool isActive,  String? photoUrl,  String? parentIqamaId,  String? parentPassportId,  String? fatherWhatsapp,  String? motherWhatsapp,  String country,  String? state,  String? studentIqamaNumber,  String? studentIqamaUrl,  String? fatherOccupation,  String? motherOccupation,  int numberOfChildren,  List<String> childrenAges,  String? shift,  bool needsTransportation,  double transportationFee,  bool hasConcession,  String instituteId,  double? scholarshipAmount,  double feeDiscount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _StudentModel() when $default != null:
return $default(_that.id,_that.fullName,_that.admissionNumber,_that.classroom,_that.dateOfBirth,_that.gender,_that.bloodGroup,_that.guardianName,_that.guardianContact,_that.address,_that.admissionDate,_that.attendancePercentage,_that.isActive,_that.photoUrl,_that.parentIqamaId,_that.parentPassportId,_that.fatherWhatsapp,_that.motherWhatsapp,_that.country,_that.state,_that.studentIqamaNumber,_that.studentIqamaUrl,_that.fatherOccupation,_that.motherOccupation,_that.numberOfChildren,_that.childrenAges,_that.shift,_that.needsTransportation,_that.transportationFee,_that.hasConcession,_that.instituteId,_that.scholarshipAmount,_that.feeDiscount);case _:
  return orElse();
...
class _StudentModel implements StudentModel {
  const _StudentModel({@JsonKey(name: '_id') required this.id, required this.fullName, @JsonKey(name: 'studentId') required this.admissionNumber, @JsonKey(name: 'grade') required this.classroom, required this.dateOfBirth, required this.gender, this.bloodGroup, this.guardianName = 'Unknown', @JsonKey(name: 'parentContact') required this.guardianContact, required this.address, @JsonKey(name: 'enrollmentDate') required this.admissionDate, this.attendancePercentage, this.isActive = true, this.photoUrl, this.parentIqamaId, this.parentPassportId, this.fatherWhatsapp, this.motherWhatsapp, this.country = 'India', this.state, this.studentIqamaNumber, this.studentIqamaUrl, this.fatherOccupation, this.motherOccupation, this.numberOfChildren = 0, final  List<String> childrenAges = const [], this.shift, this.needsTransportation = false, this.transportationFee = 0, this.hasConcession = false, this.instituteId = '664c39f00000000000000001', this.scholarshipAmount, this.feeDiscount = 0}): _childrenAges = childrenAges;
...
@override final  String? fatherWhatsapp;
@override final  String? motherWhatsapp;
@override@JsonKey() final  String country;
@override final  String? state;
@override final  String? studentIqamaNumber;
@override final  String? studentIqamaUrl;
@override final  String? fatherOccupation;
@override final  String? motherOccupation;
@override@JsonKey() final  int numberOfChildren;
 final  List<String> _childrenAges;
@override@JsonKey() List<String> get childrenAges {
...
@override@JsonKey() final  double feeDiscount;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _StudentModel&&(identical(other.id, id) || other.id == id)&&(identical(other.fullName, fullName) || other.fullName == fullName)&&(identical(other.admissionNumber, admissionNumber) || other.admissionNumber == admissionNumber)&&(identical(other.classroom, classroom) || other.classroom == classroom)&&(identical(other.dateOfBirth, dateOfBirth) || other.dateOfBirth == dateOfBirth)&&(identical(other.gender, gender) || other.gender == gender)&&(identical(other.bloodGroup, bloodGroup) || other.bloodGroup == bloodGroup)&&(identical(other.guardianName, guardianName) || other.guardianName == guardianName)&&(identical(other.guardianContact, guardianContact) || other.guardianContact == guardianContact)&&(identical(other.address, address) || other.address == address)&&(identical(other.admissionDate, admissionDate) || other.admissionDate == admissionDate)&&(identical(other.attendancePercentage, attendancePercentage) || other.attendancePercentage == attendancePercentage)&&(identical(other.isActive, isActive) || other.isActive == isActive)&&(identical(other.photoUrl, photoUrl) || other.photoUrl == photoUrl)&&(identical(other.parentIqamaId, parentIqamaId) || other.parentIqamaId == parentIqamaId)&&(identical(other.parentPassportId, parentPassportId) || other.parentPassportId == parentPassportId)&&(identical(other.fatherWhatsapp, fatherWhatsapp) || other.fatherWhatsapp == fatherWhatsapp)&&(identical(other.motherWhatsapp, motherWhatsapp) || other.motherWhatsapp == motherWhatsapp)&&(identical(other.country, country) || other.country == country)&&(identical(other.state, state) || other.state == state)&&(identical(other.studentIqamaNumber, studentIqamaNumber) || other.studentIqamaNumber == studentIqamaNumber)&&(identical(other.studentIqamaUrl, studentIqamaUrl) || other.studentIqamaUrl == studentIqamaUrl)&&(identical(other.fatherOccupation, fatherOccupation) || other.fatherOccupation == fatherOccupation)&&(identical(other.motherOccupation, motherOccupation) || other.motherOccupation == motherOccupation)&&(identical(other.numberOfChildren, numberOfChildren) || other.numberOfChildren == numberOfChildren)&&const DeepCollectionEquality().equals(other._childrenAges, _childrenAges)&&(identical(other.shift, shift) || other.shift == shift)&&(identical(other.needsTransportation, needsTransportation) || other.needsTransportation == needsTransportation)&&(identical(other.transportationFee, transportationFee) || other.transportationFee == transportationFee)&&(identical(other.hasConcession, hasConcession) || other.hasConcession == hasConcession)&&(identical(other.instituteId, instituteId) || other.instituteId == instituteId)&&(identical(other.scholarshipAmount, scholarshipAmount) || other.scholarshipAmount == scholarshipAmount)&&(identical(other.feeDiscount, feeDiscount) || other.feeDiscount == feeDiscount));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,fullName,admissionNumber,classroom,dateOfBirth,gender,bloodGroup,guardianName,guardianContact,address,admissionDate,attendancePercentage,isActive,photoUrl,parentIqamaId,parentPassportId,fatherWhatsapp,motherWhatsapp,country,state,studentIqamaNumber,studentIqamaUrl,fatherOccupation,motherOccupation,numberOfChildren,const DeepCollectionEquality().hash(_childrenAges),shift,needsTransportation,transportationFee,hasConcession,instituteId,scholarshipAmount,feeDiscount]);
...
as String?,motherOccupation: freezed == motherOccupation ? _self.motherOccupation : motherOccupation // ignore: cast_nullable_to_non_nullable
as String?,numberOfChildren: null == numberOfChildren ? _self.numberOfChildren : numberOfChildren // ignore: cast_nullable_to_non_nullable
as int,childrenAges: null == childrenAges ? _self._childrenAges : childrenAges // ignore: cast_nullable_to_non_nullable
as List<String>,shift: freezed == shift ? _self.shift : shift // ignore: cast_nullable_to_non_nullable
as String?,needsTransportation: null == needsTransportation ? _self.needsTransportation : needsTransportation // ignore: cast_nullable_to_non_nullable
as bool,transportationFee: null == transportationFee ? _self.transportationFee : transportationFee // ignore: cast_nullable_to_non_nullable
as double,hasConcession: null == hasConcession ? _self.hasConcession : hasConcession // ignore: cast_nullable_to_non_nullable
